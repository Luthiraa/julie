...
async function fileFromPath(path2, ...args) {
  const { fileFromPath: _fileFromPath } = await import("./fileFromPath-B6o3z7FF.js");
  ...
  try {
    ...
    const completion = await groq.chat.completions.create({
      messages: [
        {
          role: "system",
          content: "You are a helpful, fast, and concise AI assistant living in a liquid glass overlay on the user's screen. Keep answers short and relevant."
        },
        {
          role: "user",
          content: prompt
